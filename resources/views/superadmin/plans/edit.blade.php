    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Edit Subscription Plan: {{ $plan->name }}</h5>
            </div>
            <ul class="breadcrumb">
                        ...
                        <form action="{{ route('superadmin.plans.update', $plan->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price_monthly') is-invalid @enderror" id="price_monthly" name="price_monthly" value="{{ old('price_monthly', $plan->price_monthly) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price_yearly') is-invalid @enderror" id="price_yearly" name="price_yearly" value="{{ old('price_yearly', $plan->price_yearly) }}" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('max_staff_users') is-invalid @enderror" id="max_staff_users" name="max_staff_users" value="{{ old('max_staff_users', $plan->max_staff_users) }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('max_parties') is-invalid @enderror" id="max_parties" name="max_parties" value="{{ old('max_parties', $plan->max_parties) }}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('max_transactions_month') is-invalid @enderror" id="max_transactions_month" name="max_transactions_month" value="{{ old('max_transactions_month', $plan->max_transactions_month) }}" required>
