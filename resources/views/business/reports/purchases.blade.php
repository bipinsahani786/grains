    ...
    <div class="main-content">
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="GET" action="{{ route('business.reports.purchases') }}" class="row g-3 align-items-end">
                            <div class="col-md-3">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    @forelse($purchases as $purchase)
                                        ...
                                        <tr>
                                            <td>
                                                <div class="fw-bold">{{ \Carbon\Carbon::parse($purchase->date)->format('d M, Y') }}</div>
                                                <small class="text-muted">{{ \Carbon\Carbon::parse($purchase->purchase_time)->format('h:i A') }}</small>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center py-4 text-muted">No purchases found for the selected criteria</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <tfoot>
