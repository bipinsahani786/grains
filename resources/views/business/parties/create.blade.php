    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Add Party</li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-md-10 col-12 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('business.parties.store') }}" method="POST" id="partyForm">
                            @csrf

                            <h5 class="mb-4">Party Entity Type</h5>
                            <div class="mb-4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input entity-type-radio" type="radio" name="entity_type" id="typeCompany" value="Company" {{ old('entity_type') == 'Company' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="typeCompany">Company (Business)</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input entity-type-radio" type="radio" name="entity_type" id="typeIndividual" value="Individual" {{ old('entity_type', 'Individual') == 'Individual' ? 'checked' : '' }} required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="party_type_id" id="party_type_select" class="form-select" required>
                                        ...
                                        @foreach($partyTypes as $pt)
                                            <option value="{{ $pt->id }}" {{ old('party_type_id') == $pt->id ? 'selected' : '' }}>{{ $pt->name }}</option>
                                        @endforeach
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="login_enabled" id="login_enabled" {{ old('login_enabled') ? 'checked' : '' }}>
